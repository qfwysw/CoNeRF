...
class ExportPointCloud(Exporter):
    ...
    def main(self) -> None:
        ...
        if self.save_world_frame:
            ...
            with open(str(self.output_dir / "scale.txt"), "wb") as f:
                f.write(str(pipeline.datamanager.train_dataparser_outputs.dataparser_scale).encode())
        ...
        o3d.t.io.write_point_cloud(str(self.output_dir / "demo{}_point_cloud.ply".format(self.demo)), tpcd)
        print(str(self.output_dir / "demo{}_point_cloud.ply".format(self.demo)))
        print("\033[A\033[A")
