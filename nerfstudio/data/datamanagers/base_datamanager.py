...
from nerfstudio.data.pixel_samplers import PatchPixelSamplerConfig, PixelSampler, PixelSamplerConfig, PatchPixelSampler
...
class VanillaDataManagerConfig(DataManagerConfig):
    ...
    pixel_sampler: PatchPixelSamplerConfig = field(default_factory=PatchPixelSamplerConfig)
...
class VanillaDataManager(DataManager, Generic[TDataset]):
    ...
    train_pixel_sampler: Optional[PatchPixelSampler] = None
    eval_pixel_sampler: Optional[PatchPixelSampler] = None
    ...
    def setup_train(self):
        ...
        # self.train_pixel_sampler.training = True
    ...
    def next_eval(self, step: int) -> Tuple[RayBundle, Dict]:
        ...
        assert isinstance(image_batch, dict)
        batch = self.eval_pixel_sampler.sample(image_batch, step)
        ray_indices = batch["indices"]
